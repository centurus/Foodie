...
public class ShopCommentActivity extends Activity implements OnClickListener {
	...
	public void onClick(View v) {
		...
		case R.id.check_in_upload_img:
			Toast.makeText(ShopCommentActivity.this, "打开图库上传图片", Toast.LENGTH_SHORT)
					.show();
			break;

		case R.id.check_in_ok:
			Toast.makeText(ShopCommentActivity.this, "签到确定按钮", Toast.LENGTH_SHORT)
					.show();
			break;
